...
namespace DuckSort.UI
{
    public class SortButtonEntry : MonoBehaviour
    {
        ...
        public UnityEngine.Events.UnityAction OnClick;      // 左键点击
        public UnityEngine.Events.UnityAction OnRightClick; // 右键点击
        ...
        public SortButtonEntry(RectTransform containerRT, Button templateButton, Inventory inventory, string OrientedLabel, Comparison<Item> comparison)
        {
            ...
            OnClick = () =>
            {
                ModLogger.Info($"左键点击 {Tag})，默认排序");
                SortInventory(inventory, comparison, orderBy);
            };

            OnRightClick = () => 
            { 
                ModLogger.Info($"右键点击 {Tag}，反向排序。");
                SortInventory(inventory, comparison, !orderBy);
            };
        ...
        public void Create()
        {
            ...
            // === 右键点击处理 ===
            var clickHandler = newGO.GetComponent<SortButtonClickHandler>() ?? newGO.AddComponent<SortButtonClickHandler>();
            clickHandler.TargetButton = btn;
            clickHandler.LeftClickAction = OnClick;
            clickHandler.RightClickAction = OnRightClick;
